...
typedef nlmulret_nlboolean_nlint64_engine_event_event_Event (*function_3ycycjZrNL4nBSBtR)(nelua_vector_Event__ptr, int64_t);
...
typedef struct nlmulret_function_3ycycjZrNL4nBSBtR_nelua_vector_Event__ptr_nlint64 {
  function_3ycycjZrNL4nBSBtR r1;
  nelua_vector_Event__ptr r2;
  int64_t r3;
} nlmulret_function_3ycycjZrNL4nBSBtR_nelua_vector_Event__ptr_nlint64;
static NELUA_INLINE nlmulret_function_3ycycjZrNL4nBSBtR_nelua_vector_Event__ptr_nlint64 nelua_ipairs_1(nelua_vector_Event__ptr a);
...
typedef nlmulret_nlboolean_nlint64_engine_event_event_Event_ptr (*function_fBvbHT3KYYYwpxyM)(nelua_vector_Event__ptr, int64_t);
typedef struct nlmulret_function_fBvbHT3KYYYwpxyM_nelua_vector_Event__ptr_nlint64 {
  function_fBvbHT3KYYYwpxyM r1;
  nelua_vector_Event__ptr r2;
  int64_t r3;
} nlmulret_function_fBvbHT3KYYYwpxyM_nelua_vector_Event__ptr_nlint64;
static NELUA_INLINE nlmulret_function_fBvbHT3KYYYwpxyM_nelua_vector_Event__ptr_nlint64 nelua_mipairs_1(nelua_vector_Event__ptr a);
...
typedef nlmulret_nlboolean_nlint64_engine_gui_gui_UIWindow_ptr (*function_3SusqsK5zjofUWMxN)(nelua_vector_UIWindow__ptr, int64_t);
...
NELUA_STATIC_ASSERT(sizeof(engine_gui_gui_UIWindow) == 152 && NELUA_ALIGNOF(engine_gui_gui_UIWindow) == 8, "Nelua and C disagree on type size or align");
...
typedef struct nlmulret_function_3SusqsK5zjofUWMxN_nelua_vector_UIWindow__ptr_nlint64 {
  function_3SusqsK5zjofUWMxN r1;
  nelua_vector_UIWindow__ptr r2;
  int64_t r3;
} nlmulret_function_3SusqsK5zjofUWMxN_nelua_vector_UIWindow__ptr_nlint64;
static NELUA_INLINE nlmulret_function_3SusqsK5zjofUWMxN_nelua_vector_UIWindow__ptr_nlint64 nelua_mipairs_2(nelua_vector_UIWindow__ptr a);
...
typedef nlmulret_nlboolean_nlint64_engine_gui_gui_Widget_ptr (*function_5c2zzxzSLJ5dguBaA)(nelua_vector_Widget__ptr, int64_t);
typedef struct nlmulret_function_5c2zzxzSLJ5dguBaA_nelua_vector_Widget__ptr_nlint64 {
  function_5c2zzxzSLJ5dguBaA r1;
  nelua_vector_Widget__ptr r2;
  int64_t r3;
} nlmulret_function_5c2zzxzSLJ5dguBaA_nelua_vector_Widget__ptr_nlint64;
static NELUA_INLINE nlmulret_function_5c2zzxzSLJ5dguBaA_nelua_vector_Widget__ptr_nlint64 nelua_mipairs_3(nelua_vector_Widget__ptr a);
...
typedef nlmulret_nlboolean_nlpointer_nelua_GCItem_ptr (*function_3wZTTN7THAkdKauhD)(nelua_hashmap_iteratorT_ptr, void*);
...
typedef struct nlmulret_function_3wZTTN7THAkdKauhD_nelua_hashmap_iteratorT_nlpointer {
  function_3wZTTN7THAkdKauhD r1;
  nelua_hashmap_iteratorT r2;
  void* r3;
} nlmulret_function_3wZTTN7THAkdKauhD_nelua_hashmap_iteratorT_nlpointer;
static NELUA_INLINE nlmulret_function_3wZTTN7THAkdKauhD_nelua_hashmap_iteratorT_nlpointer nelua_mpairs_1(nelua_hashmap_pointer__GCItem__ptr a);
...
static NELUA_INLINE nlmulret_function_3wZTTN7THAkdKauhD_nelua_hashmap_iteratorT_nlpointer nelua_hashmap_pointer__GCItem____mpairs(nelua_hashmap_pointer__GCItem__ptr self);
...
typedef void (*function_4AwCSjTXcEDsFDxyn)(nelua_GC_ptr);
...
typedef void (*function_4nYiNcW4rvgym2ATe)(void*, void*);
static bool nelua_GC_step(nelua_GC_ptr self);
static void nelua_GC_register(nelua_GC_ptr self, void* ptr, uintptr_t size, uintptr_t flags, function_4nYiNcW4rvgym2ATe finalizer, void* userdata);
...
typedef int (*function_hkdFzocqrrpb3D92)(int, nlcstring_ptr);
...
static void engine_event_manager_event_manager_EventManagerRecord_Cleanup(engine_event_manager_event_manager_EventManagerRecord_ptr self);
...
NELUA_STATIC_ASSERT(sizeof(engine_uimanager_uimanager_UIManagerClass) == 24 && NELUA_ALIGNOF(engine_uimanager_uimanager_UIManagerClass) == 8, "Nelua and C disagree on type size or align");
...
NELUA_STATIC_ASSERT(sizeof(engine_render_render_RendererClass) == 1 && NELUA_ALIGNOF(engine_render_render_RendererClass) == 1, "Nelua and C disagree on type size or align");
...
static void engine_render_render_RendererClass_BeginRender(engine_render_render_RendererClass_ptr self);
typedef struct engine_engine_gui_engine_gui_EngineGUIClass engine_engine_gui_engine_gui_EngineGUIClass;
typedef engine_engine_gui_engine_gui_EngineGUIClass* engine_engine_gui_engine_gui_EngineGUIClass_ptr;
struct engine_engine_gui_engine_gui_EngineGUIClass {};
static void engine_engine_gui_engine_gui_EngineGUIClass_Startup(engine_engine_gui_engine_gui_EngineGUIClass_ptr self);
static void engine_engine_gui_engine_gui_EngineGUIClass_UpdateGUI(engine_engine_gui_engine_gui_EngineGUIClass_ptr self);
static engine_engine_gui_engine_gui_EngineGUIClass engine_engine_gui_engine_gui_EngineGUI;
...
nlmulret_function_3ycycjZrNL4nBSBtR_nelua_vector_Event__ptr_nlint64 nelua_ipairs_1(nelua_vector_Event__ptr a) {
  return (nlmulret_function_3ycycjZrNL4nBSBtR_nelua_vector_Event__ptr_nlint64){nelua_ipairs_next, a, -1};
}
...
nlmulret_function_fBvbHT3KYYYwpxyM_nelua_vector_Event__ptr_nlint64 nelua_mipairs_1(nelua_vector_Event__ptr a) {
  return (nlmulret_function_fBvbHT3KYYYwpxyM_nelua_vector_Event__ptr_nlint64){nelua_mipairs_next, a, -1};
}
...
nlmulret_function_3SusqsK5zjofUWMxN_nelua_vector_UIWindow__ptr_nlint64 nelua_mipairs_2(nelua_vector_UIWindow__ptr a) {
  return (nlmulret_function_3SusqsK5zjofUWMxN_nelua_vector_UIWindow__ptr_nlint64){nelua_mipairs_next_1, a, -1};
}
...
nlmulret_function_5c2zzxzSLJ5dguBaA_nelua_vector_Widget__ptr_nlint64 nelua_mipairs_3(nelua_vector_Widget__ptr a) {
  return (nlmulret_function_5c2zzxzSLJ5dguBaA_nelua_vector_Widget__ptr_nlint64){nelua_mipairs_next_2, a, -1};
}
nlmulret_function_3wZTTN7THAkdKauhD_nelua_hashmap_iteratorT_nlpointer nelua_mpairs_1(nelua_hashmap_pointer__GCItem__ptr a) {
  nlmulret_function_3wZTTN7THAkdKauhD_nelua_hashmap_iteratorT_nlpointer _ret_1 = nelua_hashmap_pointer__GCItem____mpairs(a);
  return (nlmulret_function_3wZTTN7THAkdKauhD_nelua_hashmap_iteratorT_nlpointer){_ret_1.r1, _ret_1.r2, _ret_1.r3};
}
...
nlmulret_function_3wZTTN7THAkdKauhD_nelua_hashmap_iteratorT_nlpointer nelua_hashmap_pointer__GCItem____mpairs(nelua_hashmap_pointer__GCItem__ptr self) {
  return (nlmulret_function_3wZTTN7THAkdKauhD_nelua_hashmap_iteratorT_nlpointer){nelua_hashmap_iteratorT_mnext, (nelua_hashmap_iteratorT){.container = self, .index = 0xffffffffffffffffULL}, NULL};
}
...
void nelua_GC_unmarkall(nelua_GC_ptr self) {
  {
    nlmulret_function_3wZTTN7THAkdKauhD_nelua_hashmap_iteratorT_nlpointer _asgnret_1 = nelua_mpairs_1((&self->items));
    function_3wZTTN7THAkdKauhD __fornext = _asgnret_1.r1;
...
void nelua_GC_mark(nelua_GC_ptr self) {
  ...
  if((self->stackbottom != 0)) {
    volatile function_4AwCSjTXcEDsFDxyn markstack = nelua_GC_markstack;
    markstack(self);
  }
}
...
void nelua_GC_registerroots(nelua_GC_ptr self) {
  nelua_GC_register((&nelua_gc), (void*)(&engine_mouse_mouse_Mouse), 40U, 131072U, (function_4nYiNcW4rvgym2ATe)NULL, (void*)NULL);
  nelua_GC_register((&nelua_gc), (void*)(&engine_event_manager_event_manager_EventManager), 24U, 131072U, (function_4nYiNcW4rvgym2ATe)NULL, (void*)NULL);
  nelua_GC_register((&nelua_gc), (void*)(&engine_uimanager_uimanager_UIManager), 24U, 131072U, (function_4nYiNcW4rvgym2ATe)NULL, (void*)NULL);
}
...
void nelua_GC_register(nelua_GC_ptr self, void* ptr, uintptr_t size, uintptr_t flags, function_4nYiNcW4rvgym2ATe finalizer, void* userdata) {
  if(NELUA_UNLIKELY((!(ptr != NULL)))) {
    return;
  }
...
int main(int argc, nlcstring_ptr argv) {
  ...
  volatile function_hkdFzocqrrpb3D92 inner_main = nelua_main;
...
nelua_span_UIWindow_ nelua_GCAllocator_spanalloc_6(nelua_GCAllocator_ptr self, nlniltype T, uintptr_t size, nlniltype flags, nlniltype finalizer, nlniltype userdata) {
  ...
  if(NELUA_LIKELY((size > 0))) {
    engine_gui_gui_UIWindow_arr0_ptr data = ((engine_gui_gui_UIWindow_arr0_ptr)nelua_GCAllocator_alloc_2(self, (size * 152), NELUA_NIL, finalizer_5, userdata_5));
...
nelua_span_UIWindow_ nelua_GCAllocator_spanrealloc_6(nelua_GCAllocator_ptr self, nelua_span_UIWindow_ s, uintptr_t size) {
  ...
  engine_gui_gui_UIWindow_arr0_ptr p = ((engine_gui_gui_UIWindow_arr0_ptr)nelua_GCAllocator_realloc(self, (void*)s.data, (size * 152), (s.size * 152)));
...
void engine_event_manager_event_manager_EventManagerRecord_RevealEvents(engine_event_manager_event_manager_EventManagerRecord_ptr self) {
  {
    nlmulret_function_3ycycjZrNL4nBSBtR_nelua_vector_Event__ptr_nlint64 _asgnret_1 = nelua_ipairs_1((&self->Events));
    function_3ycycjZrNL4nBSBtR __fornext = _asgnret_1.r1;
...
void engine_event_manager_event_manager_EventManagerRecord_FireEvent(engine_event_manager_event_manager_EventManagerRecord_ptr self, nlstring uEventName) {
  {
    nlmulret_function_fBvbHT3KYYYwpxyM_nelua_vector_Event__ptr_nlint64 _asgnret_1 = nelua_mipairs_1((&self->Events));
    function_fBvbHT3KYYYwpxyM __fornext = _asgnret_1.r1;
    nelua_vector_Event__ptr __forstate = _asgnret_1.r2;
    int64_t __fornextit = _asgnret_1.r3;
    while(true) {
...
void engine_event_manager_event_manager_EventManagerRecord_Cleanup(engine_event_manager_event_manager_EventManagerRecord_ptr self) {
  {
    nlmulret_function_fBvbHT3KYYYwpxyM_nelua_vector_Event__ptr_nlint64 _asgnret_1 = nelua_mipairs_1((&self->Events));
    function_fBvbHT3KYYYwpxyM __fornext = _asgnret_1.r1;
    nelua_vector_Event__ptr __forstate = _asgnret_1.r2;
...
void engine_gui_gui_UIWindow_Update(engine_gui_gui_UIWindow_ptr self) {
  if(engine_mouse_mouse_Mouse.insideUIElement) {
    self->grabDebounce = 0;
  }
  if((!engine_mouse_mouse_Mouse.insideUIElement)) {
  ...
  if(engine_mouse_mouse_Mouse.LMBPressed) {
    if((engine_utilities__UtilityClass_IsInsideQuad((&engine_utilities__Utility), (Vector2){(float)engine_mouse_mouse_Mouse.x, (float)engine_mouse_mouse_Mouse.y}, (Vector2){self->pos.x, self->pos.y}, (Vector2){(self->pos.x + self->size.x), (self->pos.y + self->menuBarSize)}) && (self->grabDebounce >= 3))) {
...
void engine_uimanager_uimanager_UIManagerClass_AddWidget(engine_uimanager_uimanager_UIManagerClass_ptr self, nlstring uWindowName, nlstring uWidgetName, nlstring uWidgetType, nlstring uWidgetText, int uWidgetFontSize, Vector2 uWidgetPosition, Vector2 uWidgetSize) {
  {
    nlmulret_function_3SusqsK5zjofUWMxN_nelua_vector_UIWindow__ptr_nlint64 _asgnret_1 = nelua_mipairs_2((&self->Windows));
    function_3SusqsK5zjofUWMxN __fornext = _asgnret_1.r1;
...
void engine_uimanager_uimanager_UIManagerClass_Update(engine_uimanager_uimanager_UIManagerClass_ptr self) {
  {
    ...
    while(true) {
      ...
      __fornextit = nelua_assert_narrow_nlusize_nlint64(i);
      {
        ...
        {
          nlmulret_function_5c2zzxzSLJ5dguBaA_nelua_vector_Widget__ptr_nlint64 _asgnret_3 = nelua_mipairs_3((&window->Widgets));
          function_5c2zzxzSLJ5dguBaA __fornext_1 = _asgnret_3.r1;
...
void engine_render_render_RendererClass_BeginRender(engine_render_render_RendererClass_ptr self) {
  ...
  ClearBackground((Color){12U, 15U, 16U});
...
void engine_engine_gui_engine_gui_EngineGUIClass_Startup(engine_engine_gui_engine_gui_EngineGUIClass_ptr self) {
  engine_uimanager_uimanager_UIManagerClass_AddWindow((&engine_uimanager_uimanager_UIManager), ((nlstring){(uint8_t*)"Hierarchy", 9}), ((nlstring){(uint8_t*)"HierarchyWindow", 15}), (Vector2){480.0f, 920.0f}, (Vector2){0.0f, 0.0f}, (Color){15U, 15U, 15U, 255U}, (Color){40U, 40U, 40U, 255U}, (Color){200U, 200U, 200U, 255U}, 8, 12, 32, 4, true);
  engine_event_manager_event_manager_EventManagerRecord_AddEvent((&engine_event_manager_event_manager_EventManager), ((nlstring){(uint8_t*)"ResetWindowDebounce", 19}));
}
void engine_engine_gui_engine_gui_EngineGUIClass_UpdateGUI(engine_engine_gui_engine_gui_EngineGUIClass_ptr self) {
  if(engine_event_manager_event_manager_EventManagerRecord_GetEvent((&engine_event_manager_event_manager_EventManager), ((nlstring){(uint8_t*)"HierarchyWindowMinimiseButton", 29})).fired) {
    engine_uimanager_uimanager_UIManagerClass_ToggleWindow((&engine_uimanager_uimanager_UIManager), ((nlstring){(uint8_t*)"HierarchyWindow", 15}));
    engine_information_handler_information_handler_InformationHandlerClass_Log((&engine_information_handler_information_handler_InformationHandler), ((nlstring){(uint8_t*)"Toggled window", 14}));
  }
  if(engine_event_manager_event_manager_EventManagerRecord_GetEvent((&engine_event_manager_event_manager_EventManager), ((nlstring){(uint8_t*)"HierarchyWindowResetButton", 26})).fired) {
    engine_uimanager_uimanager_UIManagerClass_ResetWindowPosition((&engine_uimanager_uimanager_UIManager), ((nlstring){(uint8_t*)"HierarchyWindow", 15}));
    engine_information_handler_information_handler_InformationHandlerClass_Log((&engine_information_handler_information_handler_InformationHandler), ((nlstring){(uint8_t*)"Reset window position.", 22}));
  }
}
...
int nelua_main(int argc, char** argv) {
  ...
  InitWindow((int)main_screenWidth, (int)main_screenHeight, (char*)"Game Engine");
  SetTargetFPS(60);
  ...
  engine_engine_gui_engine_gui_EngineGUIClass_Startup((&engine_engine_gui_engine_gui_EngineGUI));
  ...
  while((!WindowShouldClose())) {
    ...
    engine_engine_gui_engine_gui_EngineGUIClass_UpdateGUI((&engine_engine_gui_engine_gui_EngineGUI));
    engine_event_manager_event_manager_EventManagerRecord_Cleanup((&engine_event_manager_event_manager_EventManager));
    engine_mouse_mouse_MouseClass_Update((&engine_mouse_mouse_Mouse));
    if(engine_mouse_mouse_Mouse.RMBPressed) {
      engine_information_handler_information_handler_InformationHandlerClass_RaiseError((&engine_information_handler_information_handler_InformationHandler), 1, ((nlstring){(uint8_t*)"RMB was pressed, requesting an exit.", 36}));
    }
    BeginDrawing();
    engine_render_render_RendererClass_BeginRender((&engine_render_render_Renderer));
    EndDrawing();
  }
main_ErrorRaised:;
  CloseWindow();
